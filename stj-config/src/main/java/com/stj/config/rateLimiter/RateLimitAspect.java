package com.stj.config.rateLimiter;

import com.alibaba.fastjson.JSONObject;
import com.stj.common.base.result.R;
import com.stj.config.rateLimiter.annotation.RateLimite;
...
public class RateLimitAspect {
    ...
    @Pointcut("@annotation(com.stj.config.rateLimiter.annotation.RateLimite)")
