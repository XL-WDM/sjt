...
(
	...
	district_payment decimal default '0' not null comment '优惠金额(单位：分)',
	...
	payment_date timestamp default '0000-00-00 00:00:00' not null comment '支付时间',
	consign_date timestamp null comment '发货时间',
	end_date timestamp default '0000-00-00 00:00:00' not null comment '订单完成时间',
	close_date timestamp default '0000-00-00 00:00:00' not null comment '订单关闭时间',
