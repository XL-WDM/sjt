...
INSERT INTO sjt.t_product_category (id, category_name, category_level, status, icon, img_url, url, pid, create_date, update_date) VALUES (3, '随饮小憩系列', 3, 1, null, 'http://localhost/images/banner5.png', 'https://www.baidu.com/', 2, '2019-07-11 15:27:59', '2019-07-11 15:27:59');
INSERT INTO sjt.t_product_category (id, category_name, category_level, status, icon, img_url, url, pid, create_date, update_date) VALUES (4, '健康蔬果膏系列', 3, 1, null, 'http://localhost/images/banner5.png', 'https://www.baidu.com/', 2, '2019-07-11 15:27:59', '2019-07-11 15:27:59');
INSERT INTO sjt.t_product_category (id, category_name, category_level, status, icon, img_url, url, pid, create_date, update_date) VALUES (5, '养生果膏系列', 3, 1, null, 'http://localhost/images/banner5.png', 'https://www.baidu.com/', 2, '2019-07-11 17:23:41', '2019-07-11 17:23:41');
