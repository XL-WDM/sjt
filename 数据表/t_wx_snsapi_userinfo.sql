...
(
    ...
    sex varchar(1) COMMENT '用户的性别，值为1时是男性，值为2时是女性，值为0时是未知',
...
CREATE UNIQUE INDEX t_wx_snsapi_userinfo_openid_uindex ON t_wx_snsapi_userinfo (openid);
ALTER TABLE t_wx_snsapi_userinfo COMMENT = '微信用户信息';
